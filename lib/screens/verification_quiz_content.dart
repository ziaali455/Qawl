...
import 'package:first_project/widgets/quiz_audio_button.dart';
...
class QuizHomePage extends StatelessWidget {
  ...
  void _navigateToQuiz(BuildContext context) {
    // Pause the main audio player before navigating to quiz
...
//inactive but works
  ...
  void dispose() {
    _timer?.cancel();
    // Don't dispose the unified audio manager here as it's a singleton
    // Just stop any quiz audio
  ...
  void _handleTimeUp() {
    ...
    // Stop any playing quiz audio when quiz times out
    UnifiedAudioManager().stop();
  ...
  String _formatTime(int seconds) {
    ...
    void _submitAnswer() {
      ...
      // Stop any playing quiz audio before moving to next question
      UnifiedAudioManager().stop();
  ...
  Future<void> _handleQuizCompletion() async {
    ...
    // No longer resume main audio player when quiz is completed
    _showResultsDialog();
  }
